...
Future<String?> profileDialog(
  ...
  return showDialog(
    ...
    builder: (context) {
      return Expanded(
        child: AlertDialog(
          title: const Text("Coose your profile picture: ",
              style: TextStyle(fontWeight: FontWeight.w700, color: darkGrey)),
          content: Column(
            children: [
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      profileProvider.getCurrentnProfileImage();
                      Navigator.pop(context);
                    },
                    child: Row(
                      children: [
                        Icon(
                            profileProvider.profileImageChoiceId == 1
                                ? Icons.circle
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      children: [
                        Icon(
                            profileProvider.profileImageChoiceId == 2
                                ? Icons.circle
                                : Icons.circle_outlined,
                            color: darkGrey),
                        const SizedBox(width: 10),
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Row(
                      children: [
                        Icon(
                            profileProvider.profileImageChoiceId == 3
                                ? Icons.circle
                                : Icons.circle_outlined,
                            color: darkGrey),
                        const SizedBox(width: 10),
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      children: [
                        Icon(
                            profileProvider.profileImageChoiceId == 4
                                ? Icons.circle
                                : Icons.circle_outlined,
                            color: darkGrey),
                        const SizedBox(width: 10),
